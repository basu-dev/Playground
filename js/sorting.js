...
/** Side Note: Writing codes inside block ( inside curly brackets ) also
 * helps to keep global scope clean as we are using only `let` and  `const`
 * which are block scoped.
 * If we had used `var` & normal function declaration (instead of arrow functions) we should have used IIFE instead
 */
